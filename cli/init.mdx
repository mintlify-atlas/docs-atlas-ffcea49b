...
1. **Installation Location** - Choose between global (`~/.claude/`) or project-specific (`./.claude/`) installation
2. **Theme Selection** - Pick your preferred visual style and layout
3. **Color Scheme** - Select from various color palettes optimized for terminal display
4. **Feature Selection** - Enable or disable specific statusline features:
